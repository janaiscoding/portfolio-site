...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-start my-10 px-6 gap-6 md:flex-row md:justify-between md:gap-40 md:max-w-[1300px] md:mx-auto">
      <section className="flex flex-col items-start tracking-wide md:max-w-[50%]">
      ...
      <section className="relative mr-10 ">
        <img
          src={Profile}
